...
def login():
    ...
    if request.method == 'POST':
        ...
        if username == 'D3VI ONFIRE' and password == 'D3VI 786':
            # Redirect to the specified link if login is successful
            return redirect('http://fi7.bot-hosting.net:21382/')
        else:
...
<head>
    ...
    <title>Login - Devi Hosting Server</title>
    ...
    <style>
        body {
            ...
            background-image: url('https://i.ibb.co/vxQ46jSj/chat13.jpg);
...
<body>
    ...
    <h1>D3VI ONFIRE</h1>
        ...
        <img src="https://i.ibb.co/vxQ46jSj/chat13.jpg" style="width: 100%; height: auto; border-radius: 50px;">
        <h1>Back up</h1>
        <h2 class="Devi">Devi Hosting Server login˜ˆ</h2>
        ...
        <div class="admin-contact">
            <p>Need help? <a href="https://wa.me/+923263342276" target="_blank">Contact Admin</a></p>
        </div>
    </div>
</body>
</html>
